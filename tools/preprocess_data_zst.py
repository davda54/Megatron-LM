...
class Partition(object):
    ...
    def process_json_file(self, file_name):
        ...
        print("Opening", input_file_name)
        with open_file(input_file_name) as fin:
...
def open_file(in_file_name):
    """Open a file, automatically handling .gz and .zst compression."""
    if in_file_name.endswith(".gz"):
        with gzip.open(in_file_name, 'rt') as f:
            yield f
    elif in_file_name.endswith(".zst"):
    ...
    if args.partitions == 1:
        ...
        if not partitions_present and not split_sentences_present:
            ...
            for in_file_name in in_file_names:
                with open_file(in_file_name) as fin:
                    for line in fin:
